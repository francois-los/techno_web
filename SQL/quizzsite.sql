...
(12, 'Quelle est la reponse ? (entre 20 et 70)', 2, 'number'),
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `score_quizz1` int(10) NOT NULL COMMENT 'score of quizz 1',
  `score_quizz2` int(10) NOT NULL COMMENT 'score of quizz 2',
  PRIMARY KEY (`user_id`),
...
INSERT INTO `user` (`user_id`, `username`, `user_last_name`, `user_first_name`, `user_adress`, `user_phone`, `user_birthdate`, `user_password`, `score_quizz1`, `score_quizz2`) VALUES
(1, 'Apaxraa', 'Texier', 'Eloi', '10 rue de la rue', '0625488545', '1999-06-18 00:00:00', '21c1643b208fab5ba7e1b22cb534610b', 1, 0),
(2, 'Jc', 'Coudon', 'Jean-Charles', '14 rue des peupliers', '0685458556', '1999-02-17 00:00:00', '2ac9cb7dc02b3c0083eb70898e549b63', 5, 5);
